...
const fallbackHighlights = [
  { iconName: "Code2", label: "CLEAN CODE PROTOCOL", description: "Writing modular, scalable, and highly documented architectures is my baseline default." },
  { iconName: "Rocket", label: "LATENCY OPTIMIZATION", description: "Obsessed with file size reductions, request pipelines, and 60fps frame budgets." },
  { iconName: "Coffee", label: "ALGORITHMIC RESOLVER", description: "Translating convoluted business logics into clean, decoupled web applications." },
  { iconName: "Terminal", label: "SECURE INTRUSION", description: "Ensuring secure token handling, parameterized database queries, and clean input sanitizations." },
];
